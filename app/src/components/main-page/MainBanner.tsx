...
function MainBanner() {
  return (
    <div className="w-full h-[85vh] flex flex-col justify-center">
      <div className="bg-[url('/main_banner.png')] bg-cover w-full h-[100vh] absolute top-0" />
      <div className="w-full mx-auto ">
        <Carousel autoplay autoplaySpeed={6000}>
          <div className="flex justify-center items-center w-full p-5 pb-10 bg-[rgba(0,0,0,0.5)] shadow-[1px_4px_7px_0_rgba(0,0,0,0.02)]">
          ...
          <div className="flex flex-col items-start ">
            <div className="flex flex-col gap-8 text-white text-nowrap p-5 pb-10 bg-[rgba(0,0,0,0.5)] shadow-[1px_4px_7px_0_rgba(0,0,0,0.02)]">
