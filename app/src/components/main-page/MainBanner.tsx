  ...
  return (
    <div className="w-full h-[90vh] flex flex-col p-2">
      ...
      <div className="absolute w-[40rem] p-2 top-0 left-1/2 sm:left-1/4 -translate-x-1/3 flex flex-col items-start mt-[30vh] ">
        <div className="flex flex-col w-full gap-8 text-white text-nowrap p-14 bg-[rgba(0,0,0,0.5)] shadow-[0px_1px_4px_0_rgba(255,255,255,0.8)]">
          <p className="text-5xl font-anton">SWORDSUPPLY</p>
